...
export default function HeroCard({ todayWorkout, workoutCount, totalSessions }: HeroCardProps) {
  return (
    <div className="md:col-span-8 rounded-xl overflow-hidden glass-card relative min-h-[280px] flex flex-col justify-end p-24 group transition-transform duration-300 hover:-translate-y-1 ambient-shadow border-l-4 border-l-accent">

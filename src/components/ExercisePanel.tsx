...
export function ExercisePanel({ name, description, imageUrl, chips }: ExercisePanelProps) {
  return (
    <div className="glass-panel-dark rounded-xl p-md w-full max-w-lg flex flex-col items-center text-center">
      {/* Image Area */}
      <div className="w-full h-40 bg-primary-container rounded-lg mb-md overflow-hidden relative border border-white/5 flex items-center justify-center">
        {imageUrl ? (
